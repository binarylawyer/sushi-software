...
const LogosSections = () => {
  ...
  const testimonials = [
    {
      quote:
        "Elegant systems thinking paired with cutting-edge design. They delivered solutions as refined as sushi.",
      name: "Mercury, Head of Design Systems",
      image:
        "https://deifkwefumgah.cloudfront.net/shadcnblocks/block/logos/company/fictional-company-logo-3.svg",
    },
    {
      quote:
        "Minimalist interfaces with maximum impact. Their approach to complexity is refreshingly simple and intuitive.",
      name: "Perplexity, Lead Product Design",
      image:
        "https://deifkwefumgah.cloudfront.net/shadcnblocks/block/logos/company/fictional-company-logo-7.svg",
    },
    {
      quote:
        "Perfect balance of form and function. They craft software experiences that feel effortless yet powerful.",
      name: "Retool, Product Innovation Lead",
      image:
        "https://deifkwefumgah.cloudfront.net/shadcnblocks/block/logos/company/fictional-company-logo-5.svg",
    },
  ];
    ...
    <section className="py-32 pt-0">
      <div className="container flex flex-col items-center text-center">
        <h1 className="text-foreground my-6 text-lg font-semibold tracking-tight">
          Trusted by design-forward teams to build elegant solutions
        </h1>
      </div>
