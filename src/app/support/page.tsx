    ...
    <main className="w-full flex flex-col items-center overflow-hidden">
      ...
      <section className="w-full pb-12">
        <div className="container max-w-5xl px-6 mx-auto text-center">
          ...
          <p className="text-muted-foreground mt-3">Sales, technical, and legal support paths are tailored to each Sushi property.</p>
        </div>
      </section>
      ...
      <section className="w-full pb-20">
        <div className="container max-w-5xl px-6 mx-auto space-y-8">
          <div className="rounded-3xl border bg-card p-6 shadow-sm">
            ...
            <p className="text-muted-foreground leading-relaxed">Use Contact Sales for new projects, custom deployments, and partnerships.</p>
          </div>
          <div className="rounded-3xl border bg-card p-6 shadow-sm">
            <h2 className="text-2xl font-semibold mb-3">Technical support</h2>
            <p className="text-muted-foreground leading-relaxed">Sushi Kitchen stack (n8n, OCR/RAG, integrations) or Aegis Core flows.</p>
          </div>
          <div className="rounded-3xl border bg-card p-6 shadow-sm">
            <h2 className="text-2xl font-semibold mb-3">Legal & compliance</h2>
            <p className="text-muted-foreground leading-relaxed">For Sushi Legal or Sushi Law attestations, work through member firms and SLAs.</p>
          </div>
        </div>
      </section>
      <FooterSection />
